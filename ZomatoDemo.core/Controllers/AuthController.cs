...
namespace ZomatoDemo.Core.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public AuthController(UserManager<UserAC> userManager, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
        ...
        public async Task<IActionResult> Post([FromBody]LoginAC loginAC)
        {
            ...
            var identity = await GetClaimsIdentity(loginAC.Email, loginAC.Password);
